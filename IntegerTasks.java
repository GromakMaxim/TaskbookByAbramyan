...
public class IntegerTasks {
    ...
    public void integer25() {
        System.out.println("Integer25. Дни недели пронумерованы следующим образом: \n" +
                "0 — воскресенье, 1 — понедельник, 2 — вторник, …, 6 — суббота. " +
                "Дано целое число K, лежащее в диапазоне 1–365. \n" +
                "Определить номер дня недели для K-го дня года, если известно, что в этом году 1 января было четвергом.");
        System.out.println("Введите номер дня, чтобы узнать его день недели, исходя из условия задачи: ");
        System.out.println("Ответ: " + (myScan.nextInt() + 3) % 7);
    }

    public void integer26() {
        System.out.println("Integer26. Дни недели пронумерованы следующим образом: \n" +
        ...
        System.out.println("Введите номер дня, чтобы узнать его день недели, исходя из условия задачи: ");
        System.out.println("Ответ: " + (myScan.nextInt() + 1) % 7);
    }

    public void integer27() {
        System.out.println("Integer27. Дни недели пронумерованы следующим образом: \n" +
                "1 — понедельник, 2 — вторник, …, 6 — суббота, 7 — воскресенье." +
                " Дано целое число K, лежащее в диапазоне 1–365. " +
                "Определить номер дня недели для K-го дня года, если известно, что в этом году 1 января было субботой.");
        System.out.println("Введите номер дня, чтобы узнать его день недели, исходя из условия задачи: ");
        System.out.println("Ответ: " + (myScan.nextInt() + 5) % 7);
    }

    public void integer28() {
        System.out.println("Integer28. Дни недели пронумерованы следующим образом: \n" +
                "1 — понедельник, 2 — вторник, …, 6 — суббота, 7 — воскресенье. " +
        ...
        System.out.println("Введите номер дня, чтобы узнать его день недели");
        int dayNumber = myScan.nextInt();
        System.out.println("Введите с какого дня начинается отсчет новой недели");
    ...
    public void integer30() {
        System.out.println("Integer30. Дан номер некоторого года (целое положительное число). \n" +
                "Определить соответствующий ему номер столетия, учитывая, что, к примеру, началом 20 столетия был 1901 год.");
        System.out.println("Введите год");
        System.out.println("Ответ: " + (((myScan.nextInt() - 1) / 100) + 1));
    }
}
